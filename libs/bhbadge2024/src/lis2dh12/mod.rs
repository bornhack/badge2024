...
impl Lis2dh12 {
    ...
    pub async fn new(i2c: SharedI2c, addr: SlaveAddr) -> Result<Self, Error> {
        let mut dev = Self {
            i2c,
            addr: addr.addr(),
            #[cfg(feature = "out_f32")]
    ...
    /// Data rate selection,
    /// `CTRL_REG1`: `ODR`
    pub async fn set_odr(&mut self, odr: Odr) -> Result<(), Error> {
    ...
    pub async fn enable_axis(&mut self, (x, y, z): (bool, bool, bool)) -> Result<(), Error> {
    ...
    /// `CTRL_REG3`: `I1_CLICK`
    pub async fn enable_i1_click(&mut self, enable: bool) -> Result<(), Error> {
    ...
    /// `CTRL_REG3`: `I1_IA1`
    pub async fn enable_i1_ia1(&mut self, enable: bool) -> Result<(), Error> {
    ...
    /// `CTRL_REG3`: `I1_IA2`
    pub async fn enable_i1_ia2(&mut self, enable: bool) -> Result<(), Error> {
    ...
    /// `CTRL_REG3`: `I2_ZYXDA`
    pub async fn enable_i1_zyxda(&mut self, enable: bool) -> Result<(), Error> {
    ...
    /// `CTRL_REG3`: `I2_ZYXDA`
    pub async fn enable_i1_wtm(&mut self, enable: bool) -> Result<(), Error> {
    ...
    pub async fn get_stored_samples(&mut self) -> Result<u8, Error> {
    ...
    pub async fn enable_i1_overrun(&mut self, enable: bool) -> Result<(), Error> {
    ...
    /// Block data update,
    /// `CTRL_REG4`: `BDU`
    pub async fn set_bdu(&mut self, bdu: bool) -> Result<(), Error> {
    ...
    /// `CTRL_REG5`: `BOOT`
    pub async fn reboot(&mut self, reboot: bool) -> Result<(), Error> {
    ...
    /// In boot,
    /// `CTRL_REG5`: `BOOT`
    pub async fn in_boot(&mut self) -> Result<bool, Error> {
    ...
    /// FIFO enable,
    /// `CTRL_REG5`: `FIFO_EN`
    pub async fn enable_fifo(&mut self, enable: bool) -> Result<(), Error> {
    ...
    /// `CTRL_REG5`: `LIR_INT1`
    pub async fn enable_lir_int1(&mut self, latch: bool) -> Result<(), Error> {
    ...
    /// `CTRL_REG5`: `D4D_INT1`
    pub async fn enable_d4d_int1(&mut self, enable: bool) -> Result<(), Error> {
    ...
    /// `CTRL_REG5`: `LIR_INT2`
    pub async fn enable_lir_int2(&mut self, latch: bool) -> Result<(), Error> {
    ...
    /// `CTRL_REG5`: `D4D_INT2`
    pub async fn enable_d4d_int2(&mut self, enable: bool) -> Result<(), Error> {
    ...
    /// `CTRL_REG6`: `I2_CLICK`
    pub async fn enable_i2_click(&mut self, enable: bool) -> Result<(), Error> {
    ...
    /// `CTRL_REG6`: `I2_IA1`
    pub async fn enable_i2_ia1(&mut self, enable: bool) -> Result<(), Error> {
    ...
    /// `CTRL_REG6`: `I2_IA2`
    pub async fn enable_i2_ia2(&mut self, enable: bool) -> Result<(), Error> {
    ...
    /// `CTRL_REG6`: `I2_BOOT`
    pub async fn enable_i2_boot(&mut self, enable: bool) -> Result<(), Error> {
    ...
    /// `CTRL_REG6`: `I2_ACT`
    pub async fn enable_i2_act(&mut self, enable: bool) -> Result<(), Error> {
    ...
    pub async fn set_int_polarity(&mut self, active_low: bool) -> Result<(), Error> {
    ...
    pub async fn get_status(&mut self) -> Result<DataStatus, Error> {
    ...
    /// FIFO mode selection,
    /// `FIFO_CTRL_REG`: `FM`
    pub async fn set_fm(&mut self, fm: FifoMode) -> Result<(), Error> {
    ...
    /// FIFO threshold,
    /// `FIFO_CTRL_REG`: `FTH`
    pub async fn set_fth(&mut self, fth: u8) -> Result<(), Error> {
        self.modify_reg(Register::FIFO_CTRL_REG, |v| {
    ...
    pub async fn disable_click(&mut self) -> Result<(), Error> {
    ...
    pub async fn get_click_src(
        &mut self,
    ) -> Result<Option<((bool, bool), bool, (bool, bool, bool))>, Error> {
    ...
    /// `CLICK_THS`: `LIR_Click`
    pub async fn enable_lir_click(&mut self, latch: bool) -> Result<(), Error> {
    ...
    /// Click threshold,
    /// `CLICK_THS`: `Ths`
    pub async fn set_click_ths(&mut self, ths: u8) -> Result<(), Error> {
    ...
    /// Click time limit,
    /// `TIME_LIMIT`: `TLI`
    pub async fn set_time_limit(&mut self, tli: u8) -> Result<(), Error> {
    ...
    /// Click time latency,
    /// `TIME_LATENCY`: `TLA`
    pub async fn set_time_latency(&mut self, tla: u8) -> Result<(), Error> {
    ...
    /// Click time window,
    /// `TIME_WINDOW`: `TW`
    pub async fn set_time_window(&mut self, tw: u8) -> Result<(), Error> {
    ...
    /// `ACT_THS`: `Acth`
    pub async fn set_act_ths(&mut self, ths: u8) -> Result<(), Error> {
    ...
    /// `ACT_DUR`: `ActD`
    pub async fn set_act_dur(&mut self, d: u8) -> Result<(), Error> {
    ...
    pub async fn enable_temp(&mut self, enable: bool) -> Result<(), Error> {
    ...
    pub async fn get_temp_status(&mut self) -> Result<(bool, bool), Error> {
    ...
    pub async fn get_temp_out(&mut self) -> Result<(i8, u8), Error> {
        let mut buf = [0u8; 2];
    ...
    /// `REFERENCE` register
    pub async fn set_ref(&mut self, reference: u8) -> Result<(), Error> {
        self.write_reg(Register::REFERENCE, reference).await?;
        Ok(())
    }

    /// `REFERENCE` register
    pub async fn get_ref(&mut self) -> Result<u8, Error> {
        self.read_reg(Register::REFERENCE).await.map_err(Into::into)
    }

    /// INT1
    pub fn int1(&mut self) -> Int<Int1Regs> {
        Int::new(self)
    }

    /// INT2
    pub fn int2(&mut self) -> Int<Int2Regs> {
        Int::new(self)
    }
    ...
    pub async fn enable_st0(&mut self, enable: bool) -> Result<(), Error> {
    ...
    pub async fn enable_st1(&mut self, enable: bool) -> Result<(), Error> {
    ...
    pub async fn dump_regs<W>(&mut self, w: &mut W) -> Result<(), Error>
    where
        W: core::fmt::Write,
    {
        writeln!(
    ...
    pub async fn accel_raw(&mut self) -> Result<I16x3, Error> {
        let mut buf = [0u8; 6];
...
impl<'a, REG> Int<'a, REG>
where
    REG: IntRegs,
{
    fn new(dev: &'a mut Lis2dh12) -> Self {
        Self {
            dev,
            reg: PhantomData,
        }
    ...
    /// `INTx_CFG`: `AOI`, `6D`
    pub async fn set_mode(&mut self, mode: Aoi6d) -> Result<(), Error> {
        self.dev
    ...
    pub async fn enable_high(&mut self, (x, y, z): (bool, bool, bool)) -> Result<(), Error> {
        self.dev
    ...
    pub async fn enable_low(&mut self, (x, y, z): (bool, bool, bool)) -> Result<(), Error> {
        self.dev
            .modify_reg(REG::reg_cfg(), |mut v| {
    ...
    /// Threshold,
    /// `INTx_THS`: `THS`
    pub async fn set_ths(&mut self, ths: u8) -> Result<(), Error> {
    ...
    /// Duration,
    /// `INTx_DURATION`: `D`
    pub async fn set_duration(&mut self, d: u8) -> Result<(), Error> {
